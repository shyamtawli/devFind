      ...
      <div className="mb-[1.5rem] h-auto rounded-[10px] pb-[0rem] pl-[1rem] pr-[1rem] pt-[1rem] shadow-lg ">
        <div className="flex gap-[1rem]">
          ...
          <div className="w-[80%] overflow-hidden">
            ...
            <p className="skeleton mb-[0.4rem] h-[1.2rem] w-full rounded-[0.25rem]">
            ...
            <div className="flex gap-[1rem] overflow-hidden">
              {skeletonData.skills &&
                skeletonData.skills.map((skill, index) => {
                  return (
                    <div
                      className="skeleton h-[2rem] w-full rounded-[0.25rem]"
                      key={index}
                    >
                      {skill}
                    </div>
        ...
        <div className="mt-[1rem]">
          <div className="skeleton mb-[0.4rem] h-[1.2rem] w-full rounded-[0.25rem]">
            {skeletonData.bio}
          </div>
